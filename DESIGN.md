...
obvious later addition; Pagefind is not, because Pagefind indexes *pages* and the
...
- **30 weeks per page**, regardless of `per_page`. Cost is driven by repo *age*,
...
means *now*, but it is noise as a default because nobody visits an index of
...
*among projects in that language in this dataset*. This is the mechanism
