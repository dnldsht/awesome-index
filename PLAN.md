...
**Done when**: tests cover that a steady repo does not trend, a spiking repo does, a
...
| MacOS (both sources)        |   2,095 |        n/a | merged-list ordering: two curators, one row |
| selfhosted, rust, node, k8s |     n/a |     10-16% | the ordinary case                           |
